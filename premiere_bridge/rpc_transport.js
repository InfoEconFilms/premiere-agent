...
(function (root, factory) {
  ...
  var METHOD_MAP = {
    ...
    get_metadata: 'paGetMetadata',
    set_metadata: 'paSetMetadata',
    set_color_label: 'paSetColorLabel',
    get_color_label: 'paGetColorLabel',
    get_footage_interpretation: 'paGetFootageInterpretation',
    set_footage_interpretation: 'paSetFootageInterpretation',
    get_xmp_metadata: 'paGetXmpMetadata',
    set_xmp_metadata: 'paSetXmpMetadata',
    get_color_space: 'paGetColorSpace',
    import_media_files: 'paImportMediaFiles',
    import_folder: 'paImportFolder',
    relink_media: 'paRelinkMedia',
    refresh_media: 'paRefreshMedia',
    set_offline: 'paSetOffline',
    has_proxy: 'paHasProxy',
    detach_proxy: 'paDetachProxy',
    set_override_frame_rate: 'paSetOverrideFrameRate',
    set_override_pixel_aspect_ratio: 'paSetOverridePixelAspectRatio',
    set_scale_to_frame_size: 'paSetScaleToFrameSize',
    set_start_time: 'paSetStartTime',
    open_in_source: 'paOpenInSource',
    close_source_monitor: 'paCloseSourceMonitor',
    close_all_source_clips: 'paCloseAllSourceClips',
    set_source_in_out: 'paSetSourceInOut',
    insert_from_source: 'paInsertFromSource',
    overwrite_from_source: 'paOverwriteFromSource',
    get_source_monitor_info: 'paGetSourceMonitorInfo'
  };
